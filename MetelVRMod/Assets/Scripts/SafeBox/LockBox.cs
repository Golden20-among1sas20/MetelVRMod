...
public class LockBox : MonoBehaviour
{
    ...
    static LockBox _instance;
    public static LockBox instance { get { return _instance; } }
    ...
    private void Awake ()
    {
        ...
        Temp.Add (9);
        Temp.Add (0);
        Password = PlayerPrefs.GetString ("LockBoxPassword", "");
        if (Password == "") {
            ...
            Temp.RemoveAt (Index);
            PlayerPrefs.SetString ("LockBoxPassword", Password);
        }
        else {
            Sprite TempSprite = null;
            foreach (ForNum TempSprt in Numbers) {
    ...
    public void TryLogin ()
    {
        ...
        if (LoginField.text == Password) {
            //Statistic.Instance.SendStatistic ("LockBoxSuccess");
            ...
            //Statistic.Instance.SendStatistic ("LockBoxFailed");
            TryCount++;
    ...
    public void SkipPassword ()
    {
        ...
        //Statistic.Instance.SendStatistic ("LockBoxSkip");

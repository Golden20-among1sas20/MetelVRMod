...
public class PurchaseManager : MonoBehaviour, IStoreListener
{
    ...
    //[SerializeField] Text PsychopathMaskCost;
    ...
    public void OnInitialized (IStoreController controller, IExtensionProvider extensions)
    {
        ...
        NoAdsCost.text = m_StoreController.products.WithID (NC_PRODUCTS[0]).metadata.localizedPriceString;
        //PsychopathMaskCost.text = m_StoreController.products.WithID (NC_PRODUCTS[1]).metadata.localizedPriceString;
    }
